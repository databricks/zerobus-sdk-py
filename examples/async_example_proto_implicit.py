"""
Asynchronous Ingestion Example - Implicit Protobuf Mode (Default)

This example demonstrates record ingestion using the asynchronous API with implicit protobuf serialization.
...
async def main():
    print("Starting asynchronous ingestion example (Implicit Protobuf Mode)...")
    print("=" * 60)
