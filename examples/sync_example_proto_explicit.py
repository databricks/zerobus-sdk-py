"""
Synchronous Ingestion Example - Explicit Protobuf Mode

This example demonstrates record ingestion using the synchronous API with explicit protobuf serialization.
...
def main():
    print("Starting synchronous ingestion example (Explicit Protobuf Mode)...")
    print("=" * 60)
    ...
    try:
        ...
        # Step 5: Ingest pre-serialized protobuf records synchronously
        logger.info(f"\nIngesting {NUM_RECORDS} protobuf records (blocking mode, explicit serialization)...")
        ...
        try:
            for i in range(NUM_RECORDS):
                ...
                ack = stream.ingest_record(serialized_record)
